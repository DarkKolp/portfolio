...
const ExperienceLab = () => {
  return (
    <section id='portfolio' className='w-full h-full bg-[#0c0e0f] text-white py-28'>
      <h1 className='text-[25px] uppercase tracking-[10px] font-semibold text-center'>
        Images from this work
      </h1>
      {/* Images display */}
      <div className='w-full h-[3500px] grid grid-cols-1 
        ...
        <div className='w-full h-full relative overflow-hidden group'>
          ...
          <div className='absolute w-full h-full left-0 top-0'>
            ...
            group-hover:inline-block transition-opacity duration-500'>
              <h1 className='text-4xl md:text-xl text-center font-bold px-6 py-2 w-full 
