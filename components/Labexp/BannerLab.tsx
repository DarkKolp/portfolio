...
const Banner = () => {
    ...
    className="w-full h-[700px] relative text-white">
        ...
        <div className='absolute left-0 top-0 w-full h-[700px] bg-black bg-opacity-10'>
            ...
            className="w-full text-[14px] md:text-4xl px-8 py-4 flex justify-between fixed top-0 z-40 bg-black bg-opacity-25">
            ...
            <div className='w-full h-full flex flex-col justify-center items-center px-4'>
                <h1 className='text-[50px] md:text-[60px] lg:text-[100px] font-black'>Laboratory Experience</h1>
                <h3 className='text-[20px] md:text-[24px] lg:text-[40px] font-black'>Once I tried to connect atoms and molecules to assemble particles</h3>
            </div>
        </div>       
    </section>
    )
